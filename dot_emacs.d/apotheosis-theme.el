...
(custom-theme-set-faces
 'apotheosis
 '(default ((t (:family "JetBrains Mono" :foundry "JB" :width normal :height 143 :weight regular :slant normal :underline nil :overline nil :extend nil :strike-through nil :box nil :inverse-video nil :foreground "#a1b0b8" :background "#121212" :stipple nil :inherit nil))))
 '(cursor ((t (:foreground "#ff443e" :background "#FAFAFA"))))
 ...
 '(font-lock-function-call-face ((t (:foreground "#d3494e"))))
 '(font-lock-function-name-face ((t (:weight normal :slant normal :box (:line-width (1 . -1) :color "#9E9E9E" :style nil) :foreground "#fc595f"))))
 '(font-lock-keyword-face ((t (:weight semi-bold :foreground "#a63c40"))))
 ...
 '(font-lock-string-face ((t (:foreground "#df9395" :slant italic))))
 ...
 '(link-visited ((t (:weight normal :underline (:color foreground-color :style line :position nil) :foreground "#832e31"))))
