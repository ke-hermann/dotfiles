...
(custom-theme-set-faces
 ...
 '(shadow ((((class color grayscale) (min-colors 88) (background light)) (:foreground "grey50")) (((class color grayscale) (min-colors 88) (background dark)) (:foreground "grey70")) (((class color) (min-colors 8) (background light)) (:foreground "cyan")) (((class color) (min-colors 8) (background dark)) (:foreground "yellow"))))
...
(custom-theme-set-faces
 'eleuther
 '(default ((t (:inherit nil :extend nil :stipple nil :background "#121212" :foreground "tomato1" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight regular :height 158 :width normal :foundry "UKWN" :family "Iosevka"))))
 '(cursor ((t (:foreground "#F6F6F6" :background "#FAFAFA"))))
 ...
 '(shadow ((((class color grayscale) (min-colors 88) (background light)) (:foreground "grey50")) (((class color grayscale) (min-colors 88) (background dark)) (:foreground "grey70")) (((class color) (min-colors 8) (background light)) (:foreground "lime green")) (((class color) (min-colors 8) (background dark)) (:foreground "red"))))
 '(secondary-selection ((t (:extend t :background "#252525"))))
 '(trailing-whitespace ((t (:background "#DADADA"))))
 '(font-lock-bracket-face ((t (:inherit (font-lock-punctuation-face)))))
 '(font-lock-builtin-face ((t (:slant normal :foreground "#F6F6F6"))))
